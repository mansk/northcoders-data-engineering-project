...
@pytest.fixture
def dummy_dates_v2():
    return [date(2024, 1, 3), date(2024, 2, 15), date(2024, 3, 25), date(2020, 4, 1), date(2023, 5, 15), date(2024, 6, 25), date(2024, 7, 1), date(2023, 8, 15), date(2024, 9, 25) , date(2024, 10, 1), date(2023, 11, 15), date(2024, 12, 27)]
