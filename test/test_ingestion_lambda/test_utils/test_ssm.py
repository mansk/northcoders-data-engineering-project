...
class TestGetParameter:
    ...
    @pytest.mark.it("unit test: get_parameter raises ParameterNotFound for nonexistent parameter")
...
class TestSetParameter:
    ...
    def test_set_parameter(self, ssm_client):
        ...
        stored_value = ssm_client.get_parameter(Name=parameter_name)['Parameter']['Value']
    ...
    def test_set_parameter_updates_value(self, ssm_client):
        ...
        ssm_client.put_parameter(Name=parameter_name, Value=parameter_value_initial, Type='String')
